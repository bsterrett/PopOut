...
public final class Heuristic extends Thread {
	...
	Heuristic(final short empty_space_number, final short player_number,
			final short computer_number, final int heuristic_number) {
	...
	public void run() {
		if (null != p_target_board && null != p_move)
			p_alpha = evaluate_board(p_target_board, p_move);
		else {
